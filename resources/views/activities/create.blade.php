...
@section('title', 'Crear Actividad Complementaria')
...
@section('header-card')
    <div class="row">
        <div class="col-9">
            <h4 class="mb-0">Nueva Actividad Complementaria</h4>
...
@section('title-card', 'Crear Actividad Complementaria')

@section('content')
    @inject('acoms', 'App\Services\ActivityService')
    <div class="row justify-content-center">
        <div class="col-8">
            <form method="POST" name="activity" action="{{ route('admin.activity.store') }}">
                @csrf
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="acom_id" class="form-control @error('acom_id') is-invalid @enderror" name="acom_id">
                            ...
                            <option value="{{ $index }}" {{ old('acom_id') == $index ? 'selected' : '' }}>
                                {{ $acom }}
                            </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="creditos" type="text" class="form-control @error('creditos') is-invalid @enderror" name="creditos" value="{{ old('creditos') }}" autocomplete="creditos" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="duracion" type="text" class="form-control @error('duracion') is-invalid @enderror" name="duracion" value="{{ old('duracion') }}" autocomplete="duracion" autofocus>
